...
Deno.test({
  name: withinPropertyInjection("Should be able to use classes as runtime identifiers"),
  fn: () => {
    @injectable()
    class Katana {
      public hit() {
...
Deno.test({
  name: withinPropertyInjection("Should be able to use Symbols as runtime identifiers"),
  fn: () => {
    interface Ninja {
      fight(): string
      sneak(): string
...
Deno.test({
  name: "Should support the injection of user defined factories with partial application",
  ignore: true,
  fn: () => {},
})
...
Deno.test({
  name: "Should support the injection of multiple values with nested multiInject",
  ignore: true,
  fn: () => {},
})

Deno.test({
  name: "Should support the injection of multiple values when using classes as keys",
  ignore: true,
  fn: () => {},
})
...
Deno.test({
  name: "Should support the injection of multiple values when using Symbols as keys",
  ignore: true,
  fn: () => {},
})
...
Deno.test({
  name: "Should be able to resolve a ambiguous binding by providing a named tag",
  ignore: true,
  fn: () => {},
})

Deno.test({
  name: "Should be able to resolve a ambiguous binding by providing a custom tag",
  ignore: true,
  fn: () => {},
})
...
Deno.test({
  ...
  fn: () => {
    ...
    class NinjaStudent implements Ninja {
      ...
      public constructor(@inject("Weapon") @named("non-lethal") weapon: Weapon) {
        this.weapon = weapon
      }
    }
...
Deno.test({
  name: "Should support a whenAnyAncestorIs and whenNoAncestorIs contextual bindings constraint",
  ignore: true,
  fn: () => {},
})
