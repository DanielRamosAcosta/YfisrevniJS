...
export class BindingInWhenOnSyntax<T>
  implements interfaces.BindingInWhenOnSyntax<T> {
  constructor(
  ...
  whenAnyAncestorTagged(
    ...
    throw new Error(
      "Unimplemented BindingInWhenOnSyntax#whenAnyAncestorTagged",
    );
  }
  whenNoAncestorNamed(
    name: string | number | symbol,
  ...
  whenAnyAncestorMatches(
    ...
    throw new Error(
      "Unimplemented BindingInWhenOnSyntax#whenAnyAncestorMatches",
    );
  }
  whenNoAncestorMatches(
    ...
    throw new Error(
      "Unimplemented BindingInWhenOnSyntax#whenNoAncestorMatches",
    );
  }
  onActivation(
